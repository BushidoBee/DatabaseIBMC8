...
class Question (models.Model):
   ...
   grade = models.FloatField(default=0) # here I put float because if the instructor want to make question with floating grade
   is_correct = models.IntegerField(default=0) # to save the corrected answer)
...
class Submission(models.Model):
    ...
    choices = models.ManyToManyField(Choice) # Many-to-Many Relation
